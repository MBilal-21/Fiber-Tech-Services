  ...
  return (
    <footer className=" z-10">
      <div className=" mx-auto  max-w-9xl px-6 lg:px-8 relative -mb-16 z-20">
        <div class="bg-cover  bg-[url('/Assets/design-images/footer-cta-bg.jpg')]">
          <div class=" bg-custom-green/90 px-8 py-8 md:py-16 flex flex-wrap justify-center items-center">
            <div class="fadeInLeft animate__animated text-center md:text-left w-full md:w-7/12 lg:w-8/12"
            ...
            <div className="w-full md:w-5/12 lg:w-4/12">
              <div className="flex gap-4 justify-center items-center">
                <Link
                  href="/contact"
                  class="bg-custom-dark text-gray-50  animate__fadeInRight animate__animated p-4 "
                  style={{
                    visibility: "visible",
              ...
              {/* <div
              class="hotline wow fadeInRight delay-0-2s animated"
