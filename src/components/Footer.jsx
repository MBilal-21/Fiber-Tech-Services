...
const Footer = () => {
  ...
  return (
    <footer className="bg-custom-dark relative" style={{ overflow: "hidden" }}>
      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 relative z-3">
        <div className="mt-16 grid grid-cols-1 gap-8  pt-16 md:grid-cols-4 lg:grid-cols-7 dark:border-gray-800">
          <div className="text-left md:col-span-4 lg:col-span-2 order-1">
            <img src="/Assets/logo.png" alt="fiber-tech-services" width={120} />
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              ...
              <Link
                href={"/about"}
                className="footer-btn rounded-full mt-6 font-medium text-white transition hover:underline"
                type="button"
              >
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a
                  ...
                  href="#"
                >
                  <span className="text-gray-400 transition group-hover:text-gray-400/75 dark:text-white dark:group-hover:text-white/75">
                    Live Chat
                  </span>
