...
const WebDev = () => {
  return (
    <>
      <ServicePageTop heading={"Custom Web Development - Services"} />
      ...
      <div className="mx-auto  max-w-7xl  px-6  lg:px-8 py-6">
        ...
        <div className="flex flex-wrap justify-center  items-center ">
          ...
          <div className="w-full  lg:w-1/2">
            ...
            <p className="text-gray-800 text-lg">
              ...
              that are uniquely designed to meet the needs of a specific
              business. Unlike ready-made templates, custom websites are unique
              and give you more flexibility, better scalability and
        ...
        <div className="mt-8 flex flex-wrap justify-center  relative">
          <div className="w-full lg:w-1/2 sticky top-0 px-4">
            ...
            <div className="max-h-96 overflow-hidden">
              <Image
                src={"/Assets/services-images/custom-web-approach.webp"}
                width={2000}
                height={2020}
                alt="custom-web-approach"
                className="w-full h-auto py-4 object-fill"
              />
            </div>
          </div>
          <div className="w-full lg:w-1/2 px-4">
            ...
            We start by understanding what you want to achieve. Either you want
            to launch a product, improve user experience, or expand your online
            presence, we build our plan around your goals.
            <h3 className="text-custom-blue font-semibold text-lg md:text-xl pt-4 pb-2">
              {" "}
              2. Clear and Transparent{" "}
            </h3>
            We believe in being open about our costs. We provide clear estimates
            and detailed rate breakdowns, so you always know what you{"'"}re
            paying for exactly. No hidden fees, no surprises.
            <h3 className="text-custom-blue font-semibold text-lg md:text-xl pt-4 pb-2">
              3. Building Strong Relationships{" "}
            </h3>
            We value genuine, long-term relationships with our clients. We take
            a human approach, working closely with you throughout the project.
            This creates an environment where innovation can happen naturally,
            even when things look difficult.
            <h3 className="text-custom-blue font-semibold text-lg md:text-xl pt-4 pb-2">
              {" "}
              4. Flexible and Ready to Adapt{" "}
            </h3>
            Your business needs can change, and we’re ready to adjust with you.
            Our contracts and team setups are flexible, so we can make quick
            changes as needed. We regularly revisit your goals and adapt to any
            shifts in direction.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center items-center gap-4 py-8">
            <div className="flex flex-col justify-center items-center">
              <StackIcon className="h-12 w-12" name="amznwebserv" /> Amazon Web
              Services (AWS)
            </div>
            <div className="flex flex-col justify-center items-center">
              <StackIcon className="h-12 w-12" name="azure" /> Microsoft Azure
            </div>
            <div className="flex flex-col justify-center items-center">
              <StackIcon className="h-12 w-12" name="gcloud" />
              Google Cloud Platform
            </div>
            <div className="flex flex-col justify-center items-center">
              <CloudIcon className="h-12 w-12 text-gray-500" />
              Alibaba Cloud
            </div>
            <div className="flex flex-col justify-center items-center">
              <StackIcon className="h-12 w-12" name="oracle" />
        ...
        <div>
          <h2 className="text-gray-900 font-semibold text-xl md:text-3xl pt-4 pb-2 ">
            {" "}
            The Benefits of Custom Web Development{" "}
          </h2>
          <h3 className="text-custom-blue font-semibold text-lg md:text-xl pt-4 pb-2 ">
