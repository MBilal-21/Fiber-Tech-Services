...
const AboutPage = () => {
  return (
    <div>
                ...
                <div className="w-full md:w-1/2 p-2">
                  <div className="service-item style-three">
                    ...
                    <p>
                      ...
                      brand recognition, attract new customers and clients, and
                      differentiate your company from its competitors. In
                      addition, they can boost employee morale and motivate them
                ...
                <div className="w-full md:w-1/2 p-2">
                  <div className="service-item style-three">
                    ...
                    <p>
                      ...
                      startup IT solution and business development company is to
                      help startups leverage technology to achieve their
                      business goals and overcome challenges in their industry.
                      By providing a comprehensive range of services and
                      expertise, startups can focus on growing their business
                      and achieving their vision, while the IT solution and
            ...
            <div className="w-full md:w-1/2 lg:w-4/12 p-2 ">
              ...
              >
                ...
                <p>
                  ...
                  straightforward, uncomplicated, and easy to understand or use.
                  In the context of design, it refers to the idea that less is
                  often more, and that products, services, or systems should be
                  designed in a way that makes them easy to use and understand,
                  with minimal clutter and distractions. Simplicity can lead to
                  better user experiences, increased efficiency and
                  productivity, and lower costs and barriers to entry. In
                  business, it can also help companies to stand out in a crowded
                  market by offering a streamlined and straightforward solution
                  to customer needs. The principle of simplicity can be applied
                  to various aspects of business, including product design,
            ...
            <div className="w-full md:w-1/2 lg:w-4/12 p-2">
              ...
              >
                ...
                <p>
                  ...
                  volunteerism, philanthropy, and advocacy, that aim to address
                  social, environmental, and economic challenges and improve the
                  quality of life for individuals and communities. Social good
                  can also refer to the positive impact that a business or
                  organization can have on society, through practices such as
                  environmental sustainability, fair labor practices, and
                  community involvement. Companies that prioritize social good
                  often place a strong emphasis on corporate responsibility and
                  strive to balance their economic interests with the well-being
                  of society and the planet. By making a positive impact on the
                  world, companies can build stronger relationships with
                  customers, employees, and stakeholders, and contribute to a
            ...
            <div className="w-full md:w-1/2 lg:w-4/12 p-2">
              ...
              >
                ...
                <p>
                  ...
                  crucial to building long-term success and growth. To become a
                  trust partner, it is important to consistently deliver
      ...
      <section class="team-area-two relative pt-24 z-10">
        <div class="md:container mx-auto px-4">
          <div
            class="section-title text-center mb-24 wow fadeInUp delay-0-2s"
            style={{ visibility: "visible" }}
          >
            <span class="sub-title  py-2 text-lg font-bold text-custom-blue">
              Team Member
            </span>
            <h2 className="text-gray-900 font-bold text-2xl md:text-5xl pb-4">
          ...
          <div class="flex flex-wrap justify-center">
            <div class="w-full md:w-1/2 lg:w-4/12 xl:w-3/12 p-2">
              <div
                class="team-member style-two wow fadeInUp delay-0-2s"
                style={{ visibility: "visible" }}
              >
                 <Image className="img"
                  ...
                  height={230}
                />
                <h4 className="text-xl font-bold text-black">Johnathan P. Bailey</h4>
                <span class="designation text-md text-gray-500">UX/UI Designer</span>
                <div class="social-style-two gap-4">
            ...
            <div class="w-full md:w-1/2 lg:w-4/12 xl:w-3/12 p-2">
              <div
                class="team-member style-two wow fadeInUp delay-0-4s"
                style={{ visibility: "visible" }}
              >
                 <Image className="img"
                  ...
                  height={230}
                />
                <h4 className="text-xl font-bold text-black">Mark M. Hughes</h4>
                <span class="designation text-md text-gray-500">Web Developer</span>
                <div class="social-style-two gap-4">
            ...
            <div class="w-full md:w-1/2 lg:w-4/12 xl:w-3/12 p-2">
              <div
                class="team-member style-two wow fadeInUp delay-0-6s"
                style={{ visibility: "visible" }}
              >
                 <Image className="img"
                  ...
                  height={230}
                />
                <h4 className="text-xl font-bold text-black">Donald B. Mitchell</h4>
                <span class="designation text-md text-gray-500">Software Engineer</span>
                <div class="social-style-two gap-4">
            ...
            <div class="w-full md:w-1/2 lg:w-4/12 xl:w-3/12 p-2">
              <div
                class="team-member style-two wow fadeInUp delay-0-8s"
                style={{ visibility: "visible" }}
              >
                 <Image className="img"
                  ...
                  height={230}
                />
                <h4 className="text-xl font-bold text-black">Bennie N. Bannister</h4>
                <span class="designation text-md text-gray-500">Senior Consultant</span>
                <div class="social-style-two gap-4">
